package com.hana7.springdemo.jpa;
...
public class MessageTest {
	...
	void messageTest() {
		...
		String msgEn = msgsrc.getMessage("site.description", new Object[] {"하나로7기"}, Locale.ENGLISH);
		assertEquals("DEMO::하나로7기", msgEn);

		String fullMsg = MessageFormat.format("한글로는 {0}, {1} in English", msg, msgEn);
		assertEquals("한글로는 데모::하나로7기, DEMO::하나로7기 in English", fullMsg);
